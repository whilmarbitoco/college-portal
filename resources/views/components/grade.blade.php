@props(['course', 'code', 'instructor', 'prelim' => '--', 'midterm' => '--', 'finals' => '--'])

<x-card>
    <div class="flex justify-between items-center accordion-header">
        <div>
    ...
    <div class="hidden pt-4 mt-4 border-t accordion-content border-border">
